...
encoder.load_weights("encod_large_honey.h5")
decoder.load_weights("decod_large_honey.h5")
...
images = np.load("dataset_honey_large.npy")
run_gui(10, vae, images, 100)
#10 is the number of components to run the PCA, it's also the number of cursor available
